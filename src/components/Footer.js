      ...
      <div className="container" style={{ maxWidth: '960px' }} >
        <div className={`${styles.row}`}>
          ...
          <div className={styles["custom-colleft"]}>
            ...
            <p>
              <span style={{ fontWeight: 'bold', fontFamily: 'Playfair Display, serif' }}>ATENDIMENTO:</span> Psicoterapia individual.
            </p>
            <p>
              <span style={{ fontWeight: 'bold', fontFamily: 'Playfair Display, serif' }}>PÚBLICO:</span> Adolescentes, adultos e idosos.
            </p>
            <p>
              <span style={{ fontWeight: 'bold', fontFamily: 'Playfair Display, serif' }}>DESTINADO A:</span> Pessoas que falam português e residem no Brasil ou no exterior.
            </p>
            <p>
              <span style={{ fontWeight: 'bold', fontFamily: 'Playfair Display, serif' }}>MODALIDADE:</span> Online e presencial em Campo Grande - MS.
            </p>
          ...
          <div className={styles["custom-colright"]}>
            ...
            <p>
              <span style={{ fontWeight: 'bold', fontFamily: 'Playfair Display, serif' }}>CONTATO</span>
            </p>
